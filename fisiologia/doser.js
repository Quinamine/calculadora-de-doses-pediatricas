...
class Doser {
    ...
    getNotasEprecaucoes() {
        ...
        if(this.farmaco === "fenox-susp") {
            ...
            nota = `<b>(1)</b> Não tomar ao mesmo tempo que medicamentos que contêm alumínio e magnésio. <b>(2)</b>&nbsp;<strong>Contra-indicações</strong>: Hipersensibilidade (alergia) à azitromicina ou outro macrólido. Insuficiência hepática.`;
            ...
            nota = `<b>(1)</b> Para melhorar a sua absorção, os comprimidos devem ser administrados após a ingestão de alimentos ou líquidos que contenham gorduras (por ex.: leite de coco, leite de vaca, manteiga, verdura com amendoim ou coco etc.). <b>(2)</b> Se o paciente vomitar na primeira meia hora após a administração do medicamento, deve-se repetir a toma. Se os vómitos persistirem, deve ser colocada a hipótese de malária complicada. <b>(3)</b> <strong>Deve-se evitar tratar as Síndromes febris suspeitas de malária com antimaláricos sem confirmação laboratorial.</strong> O tratamento antimalárico deve ser dispensado apenas aos doentes com resultados positivos (TDRm) e/ou quando se observam parasitas no sangue ou, <strong>excepcionalmente</strong>, nos casos de suspeita em que não é possível confirmar a doença por falta dos meios auxiliares de diagnóstico (Malária clínica). <b>(4)</b> O Arteméter-Lumefantrina é bem tolerado, <b>os efeitos adversos mais frequentes são</b>: dor abdominal, anorexia (falta de apetite), náuseas, vómitos, diarreia, cefaleia (dor de cabeça), tonturas, distúrbios do sono e fadiga.`;
        } else if(this.farmaco === "al" && this.peso < 5) {
            ...
            nota = `Os efeitos secundários incluem: sonolência, sensação de fadiga, tonturas, secura da boca e visão turva. Em altas doses, pode provocar confusão e ataxia.`;
        }  else {
            nota = "";
        }
        return nota;
